<template>
    <v-card id="box" class="pa-0 ma-1">
        <v-layout column fill-height class="pa-0 ma-0 my-2">
            <h2 class="main-color center" >Total Deaths</h2>
            <h1 class="main-color center" style="line-height: 1.2em; font-size: 48px;">66 666</h1>
        </v-layout>
    </v-card>
</template>
